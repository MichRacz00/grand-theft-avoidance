...
public class SystemAdminTest {
    ...
    void correctLogin() throws InterruptedException {
        ...
        Thread.sleep(2000);
        // Correct credentials take me to the systemadmin page of my page
        String expectedUrl = "http://localhost:8080/GTA_VI/html/systemadministrator.html";
        String actualUrl = driver.getCurrentUrl();
        assertEquals(expectedUrl, actualUrl);
    }
    ...
    @Test
    void cannotAccessDivisionManagerPage() throws InterruptedException {
        correctLogin();
    ...
    @Test
    void canAccessSystemAdminPage() throws InterruptedException {
        correctLogin();
